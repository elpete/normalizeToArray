...
var GulpPaths = function () {
    ...
    _createClass(GulpPaths, [{
        ...
        value: function (_parse) {
            ...
            return {
                path: _path2.default.join(Elixir.config.basePath, path),
                name: segments.extname ? segments.basename : '',
                extension: segments.extname,
                isDir: !!!segments.extname,
                baseDir: _path2.default.join(Elixir.config.basePath, segments.extname ? segments.dirname : _path2.default.join(segments.dirname, segments.basename))
            };
        })
    }]);
