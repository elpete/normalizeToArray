...
var TestingTask = function (_Elixir$Task) {
    ...
    _createClass(TestingTask, [{
        ...
        value: function registerWatchers() {
            this.watch(this.src || this.pluginConfig('path') + this.pluginConfig('search')).watch(_path2.default.join(Elixir.config.appPaths.root, '**/*.cfc'), 'bdd').watch(_path2.default.join(Elixir.config.appPaths.root, '**/*.cfm'), 'bdd').watch(_path2.default.join(Elixir.config.viewPaths.views, '**/*.cfm'), 'bdd').watch(_path2.default.join(Elixir.config.viewPaths.layouts, '**/*.cfm'), 'bdd');
        }
